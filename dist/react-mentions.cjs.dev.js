...
var iterateMentionsMarkup = function iterateMentionsMarkup(value, config, markupIteratee) {
  ...
  while ((match = regex.exec(value)) !== null) {
    ...
    var _config$mentionChildI = config[mentionChildIndex],
        ...
        _config$mentionChildI2 = _config$mentionChildI.displayTransform,
        displayTransform = _config$mentionChildI2 === void 0 ? defaultDisplayTransform : _config$mentionChildI2;
...
var defaultMarkup = '@[__display__](__id__)';
...
var readConfigFromChildren = function readConfigFromChildren(children) {
  return React.Children.toArray(children).map(function (_ref) {
    var _ref$props = _ref.props,
        ...
        markup = _ref$props$markup === void 0 ? defaultMarkup : _ref$props$markup,
...
function SuggestionsOverlay(_ref) {
  ...
  var renderSuggestion = function renderSuggestion(result, queryInfo, index) {
    ...
    var _Children$toArray$chi = React.Children.toArray(children)[childIndex].props.renderSuggestion,
        renderSuggestion = _Children$toArray$chi === void 0 ? null : _Children$toArray$chi;
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateMentionsQueries", function (plainTextValue, caretPosition) {
      ...
      React__default.Children.forEach(children, function (child, childIndex) {
        ...
        var _child$props$trigger = child.props.trigger,
            trigger = _child$props$trigger === void 0 ? '@' : _child$props$trigger;
    ...
    _defineProperty(_assertThisInitialized(_this), "addMention", function (_ref2, _ref3) {
      ...
      var _mentionsChild$props = mentionsChild.props,
          ...
          markup = _mentionsChild$props$ === void 0 ? defaultMarkup : _mentionsChild$props$,
          _mentionsChild$props$2 = _mentionsChild$props.displayTransform,
          displayTransform = _mentionsChild$props$2 === void 0 ? defaultDisplayTransform : _mentionsChild$props$2,
